...
function get_design_template() {
	return array(
		'default' => array(
			...
			'image' => '',
			'repeat' => 'no-repeat',
			'color' => config('main-body-bg-color', '#F8F8FA'),
			'position' => 'left',
			'link' => config('link-color', '#4C4C4E'),
			'container' => ''
		),
...
register_hook('getcountry.flag', function($country) {
	$Images = array(
		'english' => url('themes/default/images/flags/english.png'),
		'arabic' => url('themes/default/images/flags/arabic.png'),
		'french' => url('themes/default/images/flags/french.png'),
		'japanese' => url('themes/default/images/flags/japan.jpg'),
		'germany' => url('themes/default/images/flags/german.png'),
		'spanish' => url('themes/default/images/flags/spanish.png'),
		'es' => url('themes/default/images/flags/spanish.png'),
		'it' => url('themes/default/images/flags/italian.png'),
		'italian' => url('themes/default/images/flags/italian.png'),
		'italiano' => url('themes/default/images/flags/italian.png')
	);
	return isset($Images[$country]) ? $Images[$country] : 'themes/default/images/flags/flag.png';
});
