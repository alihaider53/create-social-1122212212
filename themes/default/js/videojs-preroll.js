    ...
    prerollPlugin = function(options) {
        ...
        player.on('readyforpreroll', function() {
            ...
            if(settings.href !== '') {
                ...
                blocker.className = 'preroll-blocker ads-click';
                blocker.href = settings.href;
                blocker.target = settings.target || '_blank';
                blocker.onclick = function() {
                    //creating click count
                    $.ajax({
                        url: settings.click, success: function(result) {
                        }
                    });
        ...
        player.preroll.exitPreroll = function() {
            //creating video view count
            $.ajax({
                url: settings.countView, success: function(result) {
                    //	alert(settings.countView);
                }
            });
